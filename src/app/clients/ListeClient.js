      ...
      return (
        <div>
          <div className="page-header">
            <h3 className="page-title"> Ancien Client </h3>
            <nav aria-label="breadcrumb">
              <ol className="breadcrumb">
                <li className="breadcrumb-item"><a href="!#" onClick={event => event.preventDefault()}>Tables</a></li>
                <li className="breadcrumb-item active" aria-current="page">Ancien Client</li>
              </ol>
            </nav>
          </div>
          <div className="row">
            ...
            <div className="col-lg-12 grid-margin stretch-card">
              <div className="card">
                <div className="card-body">
                  <h4 className="card-title"> Listes</h4>
                  <p className="card-description"> Add Client <code></code>
                  </p>
